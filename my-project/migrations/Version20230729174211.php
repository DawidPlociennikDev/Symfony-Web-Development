 ...
 */
final class Version20230729174211 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE file ADD user_id INT DEFAULT NULL, ADD title VARCHAR(255) DEFAULT NULL, ADD format VARCHAR(255) DEFAULT NULL, ADD duration INT DEFAULT NULL, ADD pages_number INT DEFAULT NULL, ADD orientation VARCHAR(255) DEFAULT NULL');
