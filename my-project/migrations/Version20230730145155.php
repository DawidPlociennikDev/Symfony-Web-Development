 ...
 */
final class Version20230730145155 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE video (id INT NOT NULL, user_id INT DEFAULT NULL, security_user_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, format VARCHAR(255) NOT NULL, duration INT NOT NULL, created_at DATETIME NOT NULL, file VARCHAR(255) NOT NULL, INDEX IDX_7CC7DA2CA76ED395 (user_id), INDEX IDX_7CC7DA2CCA85D888 (security_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
