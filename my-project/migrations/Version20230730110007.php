 ...
 */
final class Version20230730110007 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE video (id INT NOT NULL, user_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, format VARCHAR(255) NOT NULL, duration INT NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_7CC7DA2CA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
